...
1. **Namespace & Identity**: A dedicated namespace `akeyless-k8s-python-demo` and ServiceAccount `akeyless-python-sa` are created to provide a secure boundary.
